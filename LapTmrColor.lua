...
local function bg_func()
  ...
  -- for coding!!!! local laptimesensor = getValue('s2')+8000
...
local function run_func(event)
 ...
 threshold=math.floor(threshold)
  ...
  lcd.drawText(100, 0, freq, TextSize)
  --x = lcd.getLastPos() + 4
  lcd.drawText(160, 0, threshold, TextSize)
  --x = lcd.getLastPos() + 4
  lcd.drawText(320, 0, "Lap", TextSize + INVERS)
  --x = lcd.getLastPos() + 4
  lcd.drawText(520, 0, #LapTimeList-1, TextSize)
  --x = lcd.getLastPos() + 4
  lcd.drawText(640, 0, getMinutesSecondsHundrethsAsString(ElapsedTimeMiliseconds), TextSize)
